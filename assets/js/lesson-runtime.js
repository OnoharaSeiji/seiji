(function () {
  ...
  const refsBySubject = {
    "Meta Ads": [
      {
        title: "Meta for Business · Ad objectives",
        url: "https://www.facebook.com/business/ads/ad-objectives",
        desc: "Objetivos de campanha e relação entre objetivo de negócio e entrega do sistema."
      },
      {
        title: "Meta for Business · Advantage+ campaign budget",
        url: "https://www.facebook.com/business/ads/meta-advantage-plus/budget",
        desc: "Distribuição automática de orçamento na camada de campanha."
      },
      {
        title: "Meta for Business · Advantage+ placements",
        url: "https://www.facebook.com/business/ads/meta-advantage-plus/placements",
        desc: "Placements automáticos e expansão de oportunidades de entrega."
      }
    ],
    "Google Ads": [
      {
        title: "Google Ads Help · Keyword matching options",
        url: "https://support.google.com/google-ads/answer/11586965?hl=en",
        desc: "Correspondência ampla, frase e exata e como cada uma afeta o alcance."
      },
      {
        title: "Google Ads Help · Responsive search ads",
        url: "https://support.google.com/google-ads/answer/7684791?hl=en-419",
        desc: "Como RSAs combinam assets e aprendem quais combinações performam melhor."
      },
      {
        title: "Google Ads Help · About Performance Max campaigns",
        url: "https://support.google.com/google-ads/answer/10724817?hl=en",
        desc: "Papel da PMAX, canais cobertos e lógica de otimização com IA."
      }
    ],
    "Traqueamento": [
      {
        title: "Tag Manager Help · Set up GA4 events in Tag Manager",
        url: "https://support.google.com/tagmanager/answer/13034206?hl=en",
        desc: "Passo a passo oficial para configurar eventos GA4 via GTM."
      },
      {
        title: "Analytics Help · About events",
        url: "https://support.google.com/analytics/answer/9322688?hl=en-419",
        desc: "Conceito oficial de eventos no GA4 e seus tipos."
      },
      {
        title: "Analytics Help · Conversions vs. key events in GA4",
        url: "https://support.google.com/analytics/answer/13965727?hl=en",
        desc: "Diferença atual entre key events no Analytics e conversions no Google Ads."
      }
    ],
    "n8n": [
      {
        title: "n8n Docs · Error handling",
        url: "https://docs.n8n.io/flow-logic/error-handling/",
        desc: "Tratamento de erro, error workflow e investigação de falhas."
      },
      {
        title: "n8n Docs · Stop And Error",
        url: "https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.stopanderror/",
        desc: "Como forçar falha controlada e disparar fluxos de erro."
      },
      {
        title: "n8n Docs · Dealing with errors in workflows",
        url: "https://docs.n8n.io/courses/level-two/chapter-4/",
        desc: "Leitura de executions e depuração de workflows."
      }
    ],
    "CRM": [
      {
        ...
        desc: "Base para revisão ativa, retenção e aplicação prática ao estudo."
      }
    ],
    "Prospecção ativa": [
      {
        title: "IES · Organizing Instruction and Study to Improve Student Learning",
        url: "https://ies.ed.gov/ncee/wwc/Docs/PracticeGuide/20072004.pdf",
        desc: "Base metodológica para recuperação ativa e prática deliberada."
      }
    ],
    "Vendas": [
      {
        title: "IES · Organizing Instruction and Study to Improve Student Learning",
        url: "https://ies.ed.gov/ncee/wwc/Docs/PracticeGuide/20072004.pdf",
        desc: "Base metodológica para revisão ativa, síntese e aplicação."
      }
    ],
    "n8n + CRM": [
      {
        title: "n8n Docs · Error handling",
        url: "https://docs.n8n.io/flow-logic/error-handling/",
        desc: "Base oficial sobre falhas, alerts e tratamento de execução."
      },
      {
        title: "IES · Organizing Instruction and Study to Improve Student Learning",
        url: "https://ies.ed.gov/ncee/wwc/Docs/PracticeGuide/20072004.pdf",
        desc: "Base pedagógica da estrutura de estudo e aplicação."
      }
    ],
    "Integração": [
      {
        title: "IES · Organizing Instruction and Study to Improve Student Learning",
        url: "https://ies.ed.gov/ncee/wwc/Docs/PracticeGuide/20072004.pdf",
        desc: "Base da metodologia de revisão ativa e síntese."
      }
    ],
    "Idiomas": [
      {
        title: "IES · Organizing Instruction and Study to Improve Student Learning",
        url: "https://ies.ed.gov/ncee/wwc/Docs/PracticeGuide/20072004.pdf",
        desc: "Base para repetição ativa, evocação e prática curta frequente."
      }
    ]
  };
  ...
  const loadingStyle = `
    ...
    .diagram-card{padding:22px;border-radius:22px;background:linear-gradient(180deg,rgba(96,165,250,.12),rgba(110,231,183,.08));border:1px solid rgba(110,231,183,.18);margin-top:16px}
    .svg-wrap{padding:16px;border-radius:18px;background:rgba(7,16,30,.55);border:1px solid var(--line)}
  ...
  function expandBullet(subject, bullet) {
    ...
    if (subject === "Integração" || subject === "Idiomas") {
    ...
    return "Aprofunde este tópico perguntando: que decisão concreta ele melhora no seu dia a dia?";
  }
  ...
  function quizAnswer(lesson, question) {
    ...
    if (lesson.type === "revisao") {
      return `Nesta revisão, a resposta boa é a que consegue recuperar a lógica da semana sem depender da apostila aberta. Use o objetivo da aula — ${escapeHtml(lesson.objective)} — e conecte isso com ${escapeHtml(bulletLine)}. Se a sua resposta só repete palavras soltas, ainda falta domínio operacional.`;
    }

    if (lesson.type === "teste") {
      return `No teste prático, a melhor resposta mostra critério. Ela precisa transformar ${escapeHtml(lesson.task)} em passos observáveis, justificando hipótese, ação e forma de validação. Pense na régua central deste assunto: ${escapeHtml(guide.core)}`;
    }
  ...
  function buildReviewSection(lesson, previous) {
    const prompts = Array.isArray(lesson.review) && lesson.review.length
      ? lesson.review
      : [
          `Sem consultar, explique o ponto central de “${previous ? previous.title : "a aula anterior"}”.`,
          "Cite 3 ideias que ainda estão claras na memória.",
          "O que você aplicaria hoje deste conteúdo?",
          "Qual foi a maior confusão conceitual até aqui?"
        ];
    ...
    return `
      <section class="pro-section">
        ...
        <div class="three-col" style="margin-top:16px">
          ${(lesson.bullets || []).map((bullet) => `
            <div class="map-card">
              <h3>${escapeHtml(bullet)}</h3>
              <p>${escapeHtml(expandBullet(lesson.subject, bullet))}</p>
            </div>
          `).join("")}
        </div>
      </section>
      <section class="pro-section">
        ...
        <div class="truth-grid">
          <div class="truth-card bad">
            <h3>Aplicação fraca</h3>
            <p>Executar a tarefa sem hipótese, sem critério de leitura e sem ligação com o objetivo da conta ou do processo.</p>
          </div>
          <div class="truth-card good">
            <h3>Aplicação melhor</h3>
            <p>Usar o conteúdo para tomar uma decisão mais limpa, reduzir ruído operacional e aprender algo observável com a própria execução.</p>
          </div>
        </div>
      </section>
    `;
    ...
    return `
      <section class="pro-section">
        ...
        <div class="synthesis-grid">
          ${contentLessons.map((item) => `
            <div class="synthesis-card">
              <h3>Dia ${item.dayNumber} · ${escapeHtml(item.title)}</h3>
      ...
      <section class="pro-section">
        ...
        <div class="quiz-list">
          ${(contentLessons.map((item, index) => `
            <div class="quiz-item">
              <strong>Bloco ${index + 1}</strong>
              <p>Explique com suas palavras o ponto central de “${escapeHtml(item.title)}” e diga como isso melhora uma decisão prática.</p>
            </div>
          `)).join("")}
        </div>
      </section>
      ...
      <section class="pro-section">
        ...
        <div class="framework">
          <div class="framework-step">
            ...
            <div>
              <strong>Defina o objetivo da tarefa</strong>
          ...
          <div class="framework-step">
            ...
            <div>
              <strong>Converta a missão em etapas</strong>
          ...
          <div class="framework-step">
            ...
            <div>
              <strong>Use a régua do assunto</strong>
              <p>${escapeHtml(guide.core)}</p>
            </div>
          </div>
        </div>
      ...
      <section class="pro-section">
        ...
        <div class="three-col" style="margin-top:16px">
          <div class="check-card">
            <h3>Diagnóstico</h3>
            <p>A resposta parte de dados, sinais ou etapas observáveis, não de sensação vaga.</p>
          </div>
          <div class="check-card">
            <h3>Hipótese</h3>
            <p>Existe uma explicação clara para a ação escolhida, conectada ao objetivo da tarefa.</p>
          </div>
          <div class="check-card">
            <h3>Validação</h3>
            <p>Você sabe o que observar depois para dizer se acertou ou não.</p>
          </div>
        </div>
      </section>
    `;
      ...
      <section class="pro-section">
        ...
        <div class="exercise-grid">
          <div class="exercise-card">
            <h3>Tarefa principal</h3>
            <p>${escapeHtml(lesson.task)}</p>
            <ul>
              <li>Escreva a situação atual em 3 a 5 linhas.</li>
              <li>Explique por que esta tarefa importa agora.</li>
              <li>Liste os critérios que usará para avaliar a qualidade da resposta.</li>
            </ul>
          </div>
          <div class="exercise-card">
            <h3>Checklist de qualidade</h3>
            <ul>
              <li>A tarefa está ligada ao objetivo da aula.</li>
              <li>Existe critério de decisão, não só opinião.</li>
              <li>Você consegue explicar o raciocínio sem enrolar.</li>
              <li>O resultado pode ser reutilizado na rotina.</li>
            </ul>
          </div>
        </div>
        <div class="board">
          <h3>Quadro de resposta</h3>
          <p>Use este espaço como modelo visual e depois replique no seu caderno, Notion, planilha ou documento.</p>
  ...
  function buildQuizSection(lesson) {
    const questions = Array.isArray(lesson.quiz) && lesson.quiz.length ? lesson.quiz : [
      "Explique o ponto central desta aula com suas palavras.",
      "Qual erro esta aula te ajuda a evitar?",
      "Como você aplicaria isso hoje?"
    ];
          ...
          ${questions.map((question, index) => `
            <div class="quiz-item">
              ...
              <details class="answer">
                ...
                <p>${quizAnswer(lesson, question)}</p>
              </details>
            </div>
          `).join("")}
        </div>
      ...
      <section class="pro-section">
        ...
        <div class="lang-grid">
          <div class="micro-card">
            <h3>Inglês · ${escapeHtml((lesson.english && lesson.english.goal) || "10 a 15 minutos")}</h3>
            <p>Vocabulário útil do assunto de hoje: <strong>${escapeHtml(guide.english.join(", "))}</strong>.</p>
            <ul>
              ${englishTasks.map((task) => `<li>${escapeHtml(task)}</li>`).join("")}
            </ul>
          </div>
          <div class="micro-card">
            <h3>Japonês · ${escapeHtml((lesson.japanese && lesson.japanese.goal) || "10 a 15 minutos")}</h3>
            <p>Vocabulário útil para repetição: <strong>${escapeHtml(guide.japanese.join(", "))}</strong>.</p>
            <ul>
              ${japaneseTasks.map((task) => `<li>${escapeHtml(task)}</li>`).join("")}
            </ul>
          </div>
        </div>
      </section>
      ...
      <section class="pro-section">
        ...
        <div class="three-col" style="margin-top:16px">
          <div class="glossary-card">
            <h3>Erro de conceito</h3>
            <p>O que ainda ficou confuso sobre ${escapeHtml(lesson.title.toLowerCase())}?</p>
          </div>
          <div class="glossary-card">
            <h3>Erro de execução</h3>
            <p>Em qual momento da prática você tende a travar ou simplificar demais?</p>
          </div>
          <div class="glossary-card">
            <h3>Erro recorrente</h3>
            <p>${escapeHtml(guide.errors[0] || "Anote aqui o erro que mais se repete na sua rotina.")}</p>
          </div>
        </div>
    ...
    return `
      <section class="hero-pro">
        <div class="hero-box">
          ...
          <div class="eyeline">
            <span class="pill">${escapeHtml(prettyWeekday(lesson.weekday))} · Semana ${lesson.week} · Dia ${lesson.dayNumber}</span>
            <span class="pill">${escapeHtml(lesson.subject)} · ${escapeHtml(lesson.type)}</span>
            <span class="pill">Saída prática: 1 entrega aplicável</span>
          </div>
        </div>
        <div class="mini-grid">
          <div class="mini-box">
            <strong>Por que isto importa</strong>
            <p>${escapeHtml(guide.why)}</p>
          </div>
          <div class="mini-box">
            <strong>Erro comum</strong>
            <p>${escapeHtml(guide.errors[0] || "Revisar sem critério e aplicar sem hipótese.")}</p>
          </div>
          <div class="mini-box">
  ...
  function buildMainContent(lesson, previous, weekLessons) {
    const common = [
      buildReviewSection(lesson, previous),
      lesson.type === "revisao"
        ? buildReviewCore(lesson, weekLessons)
        : lesson.type === "teste"
        ? buildTestCore(lesson)
        : buildContentCore(lesson),
      buildAppliedExercise(lesson),
      buildQuizSection(lesson),
      buildLanguageSection(lesson),
      buildErrorNotebook(lesson),
      buildReferences(lesson)
    ];
  ...
  function createPageShell(lesson, number, previous, weekLessons) {
    ...
    return `
      ...
      <header class="topbar">
        <div class="container">
          <a class="brand" href="../index.html">
            ...
            <span>seiji.study</span>
          </a>
          <nav class="nav-links" aria-label="navegação principal">
            <a class="nav-link" href="../index.html">Cronograma</a>
            <a class="nav-link active" href="#">Apostila ${lesson.week}.${lesson.dayNumber}</a>
          </nav>
        </div>
      </header>
          ...
          <div class="lesson-pro">
            <article class="card lesson-card">
              ...
              <div class="section-stack">
                ${buildMainContent(lesson, previous, weekLessons)}
              </div>

              <div class="mark-box">
                <div>
                  <strong>Marcar esta apostila como concluída</strong>
                  <p>O status é salvo no navegador deste dispositivo para aparecer no cronograma.</p>
                </div>
                <label>
                  <input id="completion-switch" class="switch" type="checkbox" aria-label="Marcar apostila como concluída">
                </label>
              </div>

              <div class="action-row">
                <a class="btn btn-secondary" href="../index.html">Retornar ao cronograma</a>
                <a class="btn btn-secondary" id="prev-lesson-link" href="../index.html">Apostila anterior</a>
                <a class="btn btn-primary" id="next-lesson-link" href="#" aria-disabled="true">Verificando próxima apostila...</a>
              </div>
            </article>
            ...
            <aside class="card aside-card">
              ...
              <div class="status-row">
                <div class="aside-mini">
                  ...
                  <span class="small-muted">${escapeHtml(plan.weeks.find(w => w.week === lesson.week)?.theme || "")}</span>
                </div>
                <div class="aside-mini">
                  <strong>Tipo</strong>
                  <span class="small-muted">${escapeHtml(lesson.type)}</span>
                </div>
                <div class="aside-mini">
                  <strong>Foco</strong>
                  <span class="small-muted">${escapeHtml((plan.weeks.find(w => w.week === lesson.week)?.focus || "").slice(0, 110))}</span>
                </div>
                <div class="aside-mini">
                  <strong>Saída prática</strong>
                  <span class="small-muted">${escapeHtml(lesson.task)}</span>
                </div>
              </div>

              <div class="callout" style="margin-top:16px">
                <strong>Checklist rápido</strong>
                <p>Antes de encerrar, confirme se você consegue explicar o conteúdo sem depender da leitura literal.</p>
              </div>

              <div class="aside-check">
                <label><input type="checkbox"> Entendi o objetivo da aula.</label>
                <label><input type="checkbox"> Consigo aplicar o conteúdo a um caso real.</label>
                <label><input type="checkbox"> Registrei pelo menos 1 erro meu.</label>
                <label><input type="checkbox"> Fiz o mini quiz com gabarito.</label>
                <label><input type="checkbox"> Revisei inglês e japonês.</label>
              </div>

              <div class="timeline-card" style="margin-top:16px">
                <h3>Resumo honesto</h3>
                <p>Se você ainda precisa reler tudo para explicar o conteúdo, a aula ainda não virou ferramenta. Volte ao exercício aplicado e reforce a lógica em voz alta.</p>
              </div>

              <div class="insight-card" style="margin-top:16px">
                <h3>O que revisar antes da próxima</h3>
                <ul>
                  ${(lesson.bullets || []).slice(0, 4).map((bullet) => `<li>${escapeHtml(bullet)}</li>`).join("")}
                </ul>
              </div>
            </aside>
          </div>
      ...
      <footer class="footer">
        <div class="container">${escapeHtml(footerText)}</div>
      </footer>
    `;
  }

  function setCompletion(lesson) {
    ...
    toggle.addEventListener("change", function () {
      ...
      saveState(next);
      localStorage.setItem(`seiji.study.complete.${lessonFile(lessonNumberFromPath()).replace(".html", "")}`, String(!!this.checked));
    });
  }
  ...
  async function wireNavigation(number) {
    ...
    if (prevLink) {
      if (prevNumber >= 1) {
        ...
        prevLink.textContent = "Retornar ao cronograma";
      }
    }
